...
function myButtonClicked() {
  ...
  document.getElementById("answer").innerHTML =
    "You have played  " + localStorage.CookieCountGoUp + " round against the bot";
...
if (random == SCISSORS && paperSelected) { 
 ...
 message = "";   
  ...
  if (localStorage.CookieCountGoUp >= 10){
   if ( localStorage.lost >= localStorage.wins && localStorage.lost >= localStorage.ties ){
    ...
    if (localStorage.CookieCountGoUp >= 10){
     if ( localStorage.ties >= localStorage.wins && localStorage.ties >= localStorage.lost){
  ...
  document.getElementById("win").innerHTML = "you have won " + localStorage.wins + " Rounds"

    document.getElementById("lose").innerHTML = "you have lost " + localStorage.lost + " Rounds"

      document.getElementById("tie").innerHTML = "you have tied " + localStorage.ties + " Rounds"

   document.getElementById("game").innerHTML = " You have played " + localStorage.average + " Games against the bot "
  
  document.getElementById("wins1").innerHTML = " You have won " + localStorage.winner + " Games against the bot "
  
  document.getElementById("lose1").innerHTML = " You have lost " + localStorage.loser + " Games against the bot "
  
  document.getElementById("ties1").innerHTML = " You have tied " + localStorage.tier + " Games against the bot "
